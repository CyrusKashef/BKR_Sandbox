...
class BETA_VENT_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x33, 0x33, 0x33, 0xFF): "Skip", # Doesn't Matter
            (0x44, 0x44, 0x44, 0xFF): "Skip", # Doesn't Matter
            (0x55, 0x55, 0x55, 0xFF): "Skip", # Doesn't Matter
            (0x99, 0x99, 0x99, 0xFF): "Skip", # Doesn't Matter
            (0xFE, 0xFE, 0xFE, 0x00): "Skip", # Doesn't Matter
            (0xFE, 0xFE, 0xFE, 0xFF): "Skip", # Doesn't Matter
            (0xFF, 0xFF, 0xFF, 0x00): "Skip", # Doesn't Matter
        }
