...
class BLACK_SNIPPET_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0x3A, 0x01, 0x00, 0xFF): "Eyes",
            (0x40, 0x0B, 0x0B, 0xFF): "Body_Top",
            (0x42, 0x00, 0x05, 0xFF): "Body_Bottom",
            (0x57, 0x22, 0x27, 0xFF): "Body_Top",
            (0x72, 0x00, 0x00, 0xFF): "Body_Bottom",
            (0x7C, 0x3B, 0x3F, 0xFF): "Body_Top",
            (0x90, 0x00, 0x02, 0xFF): "Eyes",
            (0xC0, 0x01, 0x00, 0xFF): "Body_Bottom",
            (0xC2, 0x69, 0x65, 0xFF): "Body_Top",
            (0xDF, 0xA5, 0xA0, 0xFF): "Body_Top",
            (0xFC, 0xA0, 0x00, 0xFF): "Eyes",
            (0xFF, 0x29, 0x03, 0xFF): "Body_Bottom",
...
if __name__ == '__main__':
    ...
    level_model_obj = BLACK_SNIPPET_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
