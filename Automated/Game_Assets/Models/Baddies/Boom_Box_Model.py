...
class BOOM_BOX_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0xB0, 0x9D, 0x5B, 0xFF): "Teeth",
            (0xD1, 0xD1, 0xD1, 0xFF): "Skip",
...
if __name__ == '__main__':
    ...
    level_model_obj = BOOM_BOX_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
