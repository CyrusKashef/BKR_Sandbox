...
class BUZZBOMB_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x2F, 0x04, 0x0E, 0xFF): "Mouth",
            (0x4F, 0x4F, 0x4F, 0xFF): "Skip",
            (0x54, 0x19, 0x00, 0xFF): "Body",
            (0x77, 0x24, 0x24, 0xFF): "Body",
            (0x7C, 0x4A, 0x00, 0xFF): "Body",
            (0x96, 0x83, 0x00, 0xFF): "Body",
            (0xA3, 0x10, 0x36, 0xFF): "Mouth",
            (0xC2, 0x3A, 0x39, 0xFF): "Body",
            (0xC6, 0xB5, 0x08, 0xFF): "Body",
            (0xD1, 0xB5, 0xB4, 0xFF): "Body",
            (0xE0, 0xF5, 0x1A, 0xFF): "Body",
            (0xFF, 0x34, 0x52, 0xFF): "Body",
            (0xFF, 0xFF, 0x44, 0xFF): "Body",
            (0xFF, 0xFF, 0xFF, 0x33): "Skip",
            (0xFF, 0xFF, 0xFF, 0x56): "Skip",
...
if __name__ == '__main__':
    ...
    level_model_obj = BUZZBOMB_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
