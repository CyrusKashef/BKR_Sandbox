...
class FLOTSAM_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x56, 0x0D, 0x0E, 0xFF): "Tube",
            (0x62, 0x0F, 0x10, 0xFF): "Tube",
            (0x7F, 0x14, 0x16, 0xFF): "Eyelids",
            (0xBA, 0x00, 0x00, 0xFF): "Eyelids",
            (0xDA, 0x00, 0x00, 0xFF): "Skip", # Unsure
            (0xFE, 0x89, 0x1C, 0xFF): "Eyes",
            (0xFE, 0xFF, 0xFF, 0xFF): "Skip", # Too Much
            (0xFF, 0x00, 0x00, 0xFF): "Eyelids",
            (0xFF, 0xE0, 0x57, 0xFF): "Eyes",
        }
...
if __name__ == '__main__':
    ...
    # level_model_obj = FLOTSAM_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
