...
class GRUBLIN_HOOD_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0x08, 0x1C, 0x00, 0xFF): "Pants",
            (0x10, 0x38, 0x00, 0xFF): "Pants",
            (0x24, 0x74, 0x00, 0xFF): "Pants",
            (0x38, 0x38, 0x38, 0xFF): "Sunglasses",
            (0x3F, 0x1C, 0x22, 0x00): "Body",
            (0x3F, 0x1C, 0x22, 0xFF): "Body",
            (0x46, 0x00, 0x01, 0xFF): "Mouth",
            (0x4A, 0xB2, 0x00, 0xFF): "Hat_Main",
            (0x4F, 0x4F, 0x4F, 0xFF): "Sunglasses",
            (0x6E, 0x41, 0x48, 0xFF): "Body",
            # (0x7A, 0x7A, 0x7A, 0x00): "Skip", # Too Much
            # (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Too Much
            (0x9A, 0x01, 0x00, 0xFF): "Mouth",
            (0xA4, 0x40, 0x00, 0xFF): "Ear_Inside",
            # (0xA7, 0xA7, 0xA7, 0x00): "Skip", # Too Much
            # (0xA7, 0xA7, 0xA7, 0xFF): "Skip", # Too Much
            (0xB7, 0x82, 0x8B, 0x00): "Body",
            (0xB7, 0x82, 0x8B, 0xFF): "Body",
            (0xB9, 0x69, 0x48, 0xFF): "Scarf_Gloves",
            (0xD4, 0xB5, 0xBA, 0x00): "Body",
            (0xD4, 0xB5, 0xBA, 0xFF): "Body",
            # (0xDB, 0xDB, 0xDB, 0xFF): "Skip", # Teeth
            (0xE0, 0x7E, 0x55, 0xFF): "Scarf_Gloves",
            (0xFE, 0x9D, 0x21, 0xFF): "Ear_Inside",
            # (0xFF, 0x1A, 0x0D, 0xFF): "Skip", # Unsure
            (0xFF, 0xC6, 0x8D, 0xFF): "Scarf_Gloves",
            (0xFF, 0xE6, 0x6D, 0xFF): "Ear_Inside",
...
if __name__ == '__main__':
    ...
    level_model_obj = GRUBLIN_HOOD_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
