...
class LOCKUP_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        super().__init__(file_dir, file_name)
        self._get_object_texture_header_info()
        self._get_object_vertex_header_info()
        self._texture_dict = {
            0: "Chest", # Bottom Front Outside
            1: "Chest", # Top Side In & Out
            2: "Teeth",
            3: "Chest", # Literally The Rest
            4: "Eyes",
            # 5: "Test", # Unsure
            # 6: "Test", # Unsure
            # 7: "Test", # Unsure
        ...
        self._vertex_dict = {
            ...
            (0x34, 0x34, 0x34, 0xFF): "Chest", # Inside Top
            (0x3C, 0x2D, 0x22, 0xFF): "Chest", # Inside Bottom & Side Bottoms
            (0x66, 0x4E, 0x3A, 0xFF): "Chest", # Inside Side Bottoms
            (0x78, 0x78, 0x78, 0xFF): "Chest", # Top Sides
            (0x9F, 0x79, 0x5A, 0xFF): "Chest", # Inside Front Bottoms & Back Bottoms
            (0xA4, 0xA4, 0xA4, 0xFF): "Chest", # Chest Outside Sides
            (0xC4, 0xC4, 0xC4, 0xFF): "Chest", # Front & Back Top
...
if __name__ == '__main__':
    ...
    level_model_obj = LOCKUP_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
