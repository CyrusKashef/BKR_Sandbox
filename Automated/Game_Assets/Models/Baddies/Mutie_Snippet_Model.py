...
class MUTIE_SNIPPET_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x0A, 0x24, 0x05, 0xFF): "Body_Top",
            (0x10, 0x51, 0x11, 0xFF): "Body_Top",
            (0x22, 0xA0, 0x0F, 0xFF): "Body_Top",
            (0x4F, 0x4F, 0x4F, 0xFF): "Skip", # Eye
            (0x61, 0x08, 0x1F, 0xFF): "Mouth",
            (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Eye
            (0xA7, 0xA7, 0xA7, 0xFF): "Skip", # Eye
            # (0xE8, 0x45, 0x00, 0xFF): "Skip", # Unsure
            (0xF4, 0xFF, 0xA5, 0xFF): "Body_Bottom",
            (0xFE, 0xB3, 0x51, 0xFF): "Body_Bottom",
            (0xFE, 0xFA, 0x49, 0xFF): "Body_Bottom",
            (0xFF, 0x34, 0x52, 0xFF): "Mouth",
            (0xFF, 0x76, 0x1F, 0xFF): "Body_Bottom",
            # (0xFF, 0xFF, 0xFF, 0x00): "Skip", # Too Much
            (0xFF, 0xFF, 0xFF, 0x8C): "Glow",
...
if __name__ == '__main__':
    ...
    level_model_obj = MUTIE_SNIPPET_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
