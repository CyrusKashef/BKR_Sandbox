...
class PORTRAIT_CHOMPA_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x1A, 0x0D, 0x1E, 0xFF): "Skeleton_Outside",
            # (0x3B, 0x3B, 0x3B, 0xFF): "Skip", # Teeth & Eyes
            (0x3F, 0x2A, 0x45, 0xFF): "Skeleton_Outside",
            (0x4B, 0x16, 0x20, 0xFF): "Skeleton_Inside",
            (0x5A, 0x3B, 0x62, 0xFF): "Skeleton_Outside",
            # (0x83, 0x83, 0x83, 0xFF): "Skip", # Teeth & Eyes
            (0x88, 0x61, 0x93, 0xFF): "Skeleton_Outside",
            (0xB1, 0x93, 0xB7, 0xFF): "Skeleton_Outside",
            # (0xB6, 0xB6, 0xB6, 0xFF): "Skip", # Eyes
            (0xD4, 0x57, 0x75, 0xFF): "Skeleton_Inside",
            (0xF2, 0xC3, 0xC6, 0xFF): "Skeleton_Inside",
...
if __name__ == '__main__':
    ...
    level_model_obj = PORTRAIT_CHOMPA_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
