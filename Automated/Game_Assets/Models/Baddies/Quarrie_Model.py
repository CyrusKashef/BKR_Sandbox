...
class QUARRIE_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x53, 0x3B, 0x0C, 0xFF): "Body",
            # (0x88, 0x88, 0x88, 0xFF): "Skip", # Body & Eyes
            (0x8A, 0x72, 0x41, 0xFF): "Body",
            (0xA0, 0x79, 0x52, 0xFF): "Body",
            (0xA4, 0x7C, 0x54, 0xFF): "Body",
            (0xA5, 0x8E, 0x62, 0xFF): "Body",
            (0xB6, 0x9C, 0x6C, 0xFF): "Body",
            (0xB6, 0xA4, 0x48, 0xFF): "Body", # Eyelids
            (0xD6, 0xB0, 0x8A, 0xFF): "Body",
            (0xD8, 0xBF, 0x8C, 0xFF): "Body",
            # (0xE0, 0xA8, 0x45, 0xFF): "Skip", # Unsure
            (0xFE, 0xFE, 0xFE, 0xFF): "Body",
...
if __name__ == '__main__':
    ...
    level_model_obj = QUARRIE_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
