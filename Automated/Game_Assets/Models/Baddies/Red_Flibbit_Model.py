...
class RED_FLIBBIT_MODEL_CLASS(GENERIC_MODEL_CLASS):
...
if __name__ == '__main__':
    ...
    level_model_obj = RED_FLIBBIT_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
