...
class RIPPER_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x1B, 0x29, 0x16, 0xFF): "Body",
            # (0x20, 0x20, 0x20, 0xFF): "Skip", # Eyes
            (0x37, 0x5D, 0x2A, 0xFF): "Body",
            (0x38, 0x38, 0x38, 0xFF): "Body", # & Eyes?
            (0x4F, 0x4F, 0x4F, 0xFF): "Body", # & Eyes?
            (0x7A, 0x7A, 0x7A, 0xFF): "Body", # & Eyes?
            (0xA7, 0xA7, 0xA7, 0xFF): "Body",
            (0xCA, 0xEF, 0xB0, 0xFF): "Body",
...
if __name__ == '__main__':
    ...
    level_model_obj = RIPPER_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
