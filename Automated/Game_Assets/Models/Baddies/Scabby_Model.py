...
class SCABBY_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0x11, 0x14, 0x1C, 0xFF): "Face_Wing_Flaps",
            # (0x20, 0x20, 0x20, 0xFF): "Skip", # Eyes
            (0x26, 0x0B, 0x0B, 0xFF): "Body_Lower",
            (0x36, 0x01, 0x02, 0xFF): "Body_Lower",
            (0x48, 0x51, 0x69, 0xFF): "Face_Wing_Flaps",
            # (0x4F, 0x4F, 0x4F, 0xFF): "Skip", # Eyes
            (0x56, 0x2E, 0x00, 0xFF): "Body_Lower",
            (0x7A, 0x7A, 0x7A, 0xFF): "Body_Lower",
            (0x8C, 0x28, 0x00, 0xFF): "Body_Lower",
            (0x90, 0x61, 0x00, 0xFF): "Body_Lower",
            (0xA3, 0x0E, 0x13, 0xFF): "Face_Wing_Flaps",
            (0xBC, 0xA9, 0x00, 0xFF): "Body_Lower",
            (0xDE, 0xD6, 0x9D, 0x44): "Wings", # Lowest
            (0xDE, 0xD6, 0x9D, 0x75): "Wings", # Middle
            (0xDE, 0xD6, 0x9D, 0xB2): "Wings", # Upper
            (0xE0, 0x70, 0x00, 0xFF): "Body_Lower",
            (0xE6, 0xE8, 0xED, 0xFF): "Face_Wing_Flaps",
            (0xF7, 0xFE, 0x80, 0xFF): "Body_Lower",
            (0xFD, 0xFA, 0x79, 0xFF): "Body_Lower",
            (0xFF, 0x33, 0x36, 0xFF): "Face_Wing_Flaps",
...
if __name__ == '__main__':
    ...
    level_model_obj = SCABBY_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
