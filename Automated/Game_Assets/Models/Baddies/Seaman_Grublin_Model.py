...
class SEAMAN_GRUBLIN_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0x0E, 0x0E, 0x29, 0xFF): "Pants",
            (0x1B, 0x1B, 0x56, 0xFF): "Pants",
            (0x1D, 0x22, 0x0F, 0x00): "Body",
            (0x1D, 0x22, 0x0F, 0xFF): "Body",
            (0x20, 0x20, 0x20, 0xFF): "Shoes",
            (0x2D, 0x2D, 0x90, 0xFF): "Pants",
            (0x3C, 0x43, 0x28, 0xFF): "Body",
            (0x40, 0x40, 0xC1, 0xFF): "Pants",
            (0x4E, 0x33, 0x1B, 0xFF): "Teeth",
            (0x52, 0x1A, 0x00, 0xFF): "Ear",
            (0x61, 0x06, 0x0A, 0xFF): "Mouth",
            (0x6D, 0x79, 0x4D, 0x00): "Body",
            (0x6D, 0x79, 0x4D, 0xFF): "Body",
            (0x6F, 0x55, 0x3E, 0xFF): "Teeth",
            # (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Eyes
            (0x88, 0x3F, 0x00, 0xFF): "Ear",
            (0x9A, 0x78, 0x5B, 0xFF): "Hat_Cape",
            (0xAD, 0xB9, 0x8C, 0xFF): "Body",
            (0xC0, 0x9A, 0x77, 0xFF): "Hat_Cape",
            # (0xDB, 0xDB, 0xDB, 0xFF): "Skip", # Eyes
            (0xDF, 0xB7, 0x93, 0xFF): "Hat_Cape",
            (0xF2, 0xB1, 0x00, 0xFF): "Ear",
...
if __name__ == '__main__':
    ...
    level_model_obj = SEAMAN_GRUBLIN_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
