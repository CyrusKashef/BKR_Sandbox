...
class SLAPPA_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x14, 0x18, 0x08, 0xFF): "Body",
            (0x20, 0x20, 0x20, 0x00): "Body",
            (0x20, 0x20, 0x20, 0xFF): "Body",
            (0x36, 0x23, 0x15, 0xFF): "Body",
            (0x38, 0x38, 0x38, 0xFF): "Body",
            (0x4F, 0x4F, 0x4F, 0x00): "Body",
            (0x4F, 0x4F, 0x4F, 0xFF): "Body",
            (0x52, 0x63, 0x22, 0x00): "Body",
            (0x52, 0x63, 0x22, 0xFF): "Body",
            (0x7A, 0x7A, 0x7A, 0x00): "Body",
            (0x7A, 0x7A, 0x7A, 0xFF): "Body",
            (0x9E, 0x73, 0x4D, 0x00): "Body",
            (0x9E, 0x73, 0x4D, 0xFF): "Body",
            (0xA7, 0xA7, 0xA7, 0xFF): "Body",
            (0xB6, 0xCE, 0x75, 0x00): "Body",
            (0xB6, 0xCE, 0x75, 0xFF): "Body",
            (0xFB, 0xE7, 0xA2, 0xFF): "Body",
            (0xFF, 0xFF, 0xFF, 0x00): "Body",
...
if __name__ == '__main__':
    ...
    level_model_obj = SLAPPA_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
