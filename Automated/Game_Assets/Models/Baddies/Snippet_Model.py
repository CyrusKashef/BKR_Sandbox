...
class SNIPPET_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x14, 0x18, 0x00, 0xFF): "Body_Top",
            (0x26, 0x0B, 0x0B, 0xFF): "Body_Top",
            (0x26, 0x34, 0x07, 0xFF): "Body_Bottom",
            (0x26, 0x36, 0x00, 0xFF): "Body_Top",
            (0x40, 0x0B, 0x0B, 0xFF): "Body_Top",
            # (0x4F, 0x4F, 0x4F, 0xFF): "Skip", # Eyes
            (0x57, 0x22, 0x27, 0xFF): "Body_Top",
            (0x61, 0x08, 0x1F, 0xFF): "Mouth",
            (0x6C, 0x86, 0x00, 0xFF): "Body_Top",
            # (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Eyes
            (0x7C, 0x3B, 0x3F, 0xFF): "Body_Top",
            (0x8D, 0xD5, 0x26, 0xFF): "Body_Top",
            (0xA4, 0x19, 0x00, 0xFF): "Body_Bottom",
            (0xA7, 0xA7, 0xA7, 0xFF): "Skip", # Eyes
            (0xC2, 0x69, 0x65, 0xFF): "Body_Top",
            (0xDF, 0xA5, 0xA0, 0xFF): "Body_Top",
            (0xFD, 0x3A, 0x11, 0xFF): "Body_Bottom",
            (0xFD, 0x46, 0x31, 0xFF): "Body_Bottom",
            (0xFD, 0x7B, 0x79, 0xFF): "Body_Bottom",
            (0xFF, 0x34, 0x52, 0xFF): "Mouth",
            (0xFF, 0xB7, 0xBF, 0xFF): "Body_Bottom",
            (0xFF, 0xDD, 0xDD, 0xFF): "Body_Top",
...
if __name__ == '__main__':
    ...
    level_model_obj = SNIPPET_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
