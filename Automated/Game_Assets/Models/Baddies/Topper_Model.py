...
class TOPPER_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            ...
            (0x4F, 0x4F, 0x4F, 0xFF): "Leaves",
            (0x62, 0x13, 0x00, 0x00): "Body",
            (0x62, 0x13, 0x00, 0xFF): "Body",
            # (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Eyes
            (0x88, 0x1A, 0x00, 0xFF): "Body",
            # (0xA7, 0xA7, 0xA7, 0xFF): "Skip", # Eyes
            (0xB2, 0x23, 0x00, 0x00): "Body",
            (0xB2, 0x23, 0x00, 0xFF): "Body",
            (0xDE, 0x2B, 0x00, 0xFF): "Body",
            (0xFD, 0x8A, 0x2E, 0xFF): "Body",
            (0xFD, 0x9F, 0x44, 0x00): "Body", # Body & Leaves
            (0xFD, 0x9F, 0x44, 0xFF): "Body", # Body & Leaves
            (0xFD, 0xBA, 0x44, 0x00): "Leaves",
            (0xFD, 0xBA, 0x44, 0xFF): "Leaves",
            (0xFE, 0x7C, 0x00, 0xFF): "Body",
            (0xFF, 0x55, 0x05, 0x00): "Body",
            (0xFF, 0x55, 0x05, 0xFF): "Body",
            # (0xFF, 0xFF, 0xFF, 0x00): "Test", # Too Much
...
if __name__ == '__main__':
    ...
    level_model_obj = TOPPER_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
