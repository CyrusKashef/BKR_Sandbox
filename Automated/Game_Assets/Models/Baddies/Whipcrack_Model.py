...
class WHIPCRACK_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x20, 0x20, 0x20, 0x00): "Body",
            (0x20, 0x20, 0x20, 0xFF): "Body",
            (0x46, 0x7F, 0x1C, 0x00): "Body",
            (0x46, 0x7F, 0x1C, 0xFF): "Body",
            (0x4F, 0x4F, 0x4F, 0xFF): "Body",
            (0x6F, 0x55, 0x3E, 0x00): "Body",
            (0x6F, 0x55, 0x3E, 0xFF): "Body",
            (0x73, 0xD0, 0x29, 0x00): "Moss",
            (0x73, 0xD0, 0x29, 0xFF): "Moss",
            (0x7A, 0x7A, 0x7A, 0x00): "Body",
            (0x7A, 0x7A, 0x7A, 0xFF): "Body",
            (0x9C, 0x57, 0x3B, 0x00): "Body",
            (0x9C, 0x57, 0x3B, 0xFF): "Body",
            (0xA7, 0xA7, 0xA7, 0x00): "Body",
            (0xA7, 0xA7, 0xA7, 0xFF): "Body",
            (0xFF, 0x9C, 0x6B, 0x00): "Body",
            (0xFF, 0x9C, 0x6B, 0xFF): "Body",
...
if __name__ == '__main__':
    ...
    level_model_obj = WHIPCRACK_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
