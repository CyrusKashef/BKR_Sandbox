...
class WHIPLASH_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x3A, 0x00, 0x00, 0x00): "Whip",
            (0x3A, 0x00, 0x00, 0xFF): "Whip",
            (0x4F, 0x4F, 0x4F, 0x00): "Whip",
            (0x4F, 0x4F, 0x4F, 0xFF): "Whip",
            (0x61, 0x08, 0x1F, 0x00): "Whip",
            (0x61, 0x08, 0x1F, 0xFF): "Whip",
            (0x80, 0x00, 0x02, 0xFF): "Whip",
            (0xE8, 0x00, 0x03, 0x00): "Whip",
            (0xE8, 0x00, 0x03, 0xFF): "Whip",
...
if __name__ == '__main__':
    ...
    level_model_obj = WHIPLASH_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
