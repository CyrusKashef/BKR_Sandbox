...
class YUM_YUM_MODEL_CLASS(GENERIC_MODEL_CLASS):
    def __init__(self, file_dir, file_name):
        ...
        self._vertex_dict = {
            (0x2D, 0x00, 0x00, 0xFF): "Mouth",
            # (0x38, 0x38, 0x38, 0xFF): "Skip", # Eyes
            (0x3C, 0x2B, 0x13, 0x00): "Body",
            (0x3C, 0x2B, 0x13, 0xFF): "Body",
            (0x61, 0x08, 0x1F, 0xFF): "Mouth",
            (0x6F, 0x65, 0x3E, 0xFF): "Body",
            # (0x7A, 0x7A, 0x7A, 0xFF): "Skip", # Eyes
            (0xA3, 0x10, 0x36, 0xFF): "Mouth",
            # (0xA7, 0xA7, 0xA7, 0xFF): "Skip", # Eyes
            (0xC0, 0xA9, 0x76, 0x00): "Body",
            (0xC0, 0xA9, 0x76, 0xFF): "Body",
            (0xE4, 0x8B, 0x94, 0xFF): "Mouth",
            (0xFB, 0xDA, 0xB2, 0x00): "Body",
            (0xFB, 0xDA, 0xB2, 0xFF): "Body",
            (0xFF, 0x5C, 0x71, 0xFF): "Mouth",
...
if __name__ == '__main__':
    ...
    # level_model_obj = YUM_YUM_MODEL_CLASS(f"{MODEL_DIR}{MODEL_NAME}_Models/", f"{FILE_NAME}-{JSON_FILE_NAME[:-5]}")
