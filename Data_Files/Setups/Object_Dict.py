PHYSICAL_OBJECT_DICT = {
    ...
    (0x00CE, 0x190C): "Camera Controller 2",
    ...
    (0x03B7, 0x010C): "Jigsaw Podium (TTC)",
...
MISC_OBJECT_DICT = {
    ...
    (0x0373, 0x008C): "Unknown (Possible Moves Dialog? MM Entrance)",
    (0x0373, 0x010C): "Unknown (Possible Moves Dialog? TTC Entrance)",
    (0x0373, 0x018C): "Unknown (Possible Moves Dialog? CC Entrance)",
    (0x0373, 0x020C): "Unknown (Possible Moves Dialog? BGS Entrance)",
    (0x0373, 0x028C): "Unknown (Possible Moves Dialog? FP Entrance)",
    (0x0373, 0x030C): "Unknown (Possible Moves Dialog? GV Entrance)",
}

FOUND_UNKNOWN_OBJECT_DICT = {
    # (Object Id, Script Id)
    # (0x0000, 0x0001): [
    ...
    #     ],
    (0x0016, 0x190C): [
        "4C4680", # SM - Spiral Mountain, 2877 -500 6368
        "4C7918", # TTC - Blubber's Ship
