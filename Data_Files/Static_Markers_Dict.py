...
BANJO_SOULIE_MARKERS = {
    ...
    0xD8BE: { # Yellow Flibbit
        CLAW_SWIPE:      [0, 2, 4, 0, 3, 2],
        ROLL_ATTACK:     [0, 2, 3, 0, 2, 2],
        RATATAP_RAP:     [0, 2, 3, 0, 2, 2],
        BEAK_BARGE:      [0, 2, 4, 0, 2, 2],
        BEAK_BUSTER:     [0, 2, 4, 0, 2, 2],
        EGG_FIRING:      [0, 2, 3, 0, 3, 2],
        WONDERWING:      [0, 2, 4, 0, 1, 2],
        CROC_BITE:       [0, 2, 3, 0, 1, 3],
    },
    0xD8D8: { # Buzzbomb
        CLAW_SWIPE:      [0, 2, 0, 0, 1, 2],
        ROLL_ATTACK:     [0, 2, 0, 0, 1, 2],
        RATATAP_RAP:     [0, 2, 0, 0, 1, 2],
        BEAK_BARGE:      [0, 2, 0, 0, 1, 2],
